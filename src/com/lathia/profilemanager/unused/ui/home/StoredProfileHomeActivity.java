...
//				{
//					Intent intent = new Intent(StoredProfileHomeActivity.this, getDistributionActivityClass());
//					intent.putExtra(getIntentKeyForDistributionData(), distribution);
//					startActivity(intent);
//				}
//				else
//				{
//					Toast.makeText(StoredProfileHomeActivity.this, getNoDataMessage(), Toast.LENGTH_SHORT).show();
//				}
//			}
//		});
//	}
